...
export interface HexagonImageProps extends AccessibilityProps, ViewProps {
...
export interface HexagonImageStaticProperties {
...
declare const HexagonImage: React.ComponentType<HexagonImageProps> &
  HexagonImageStaticProperties;
