#import "RCTConvert+FFHexagonImage.h"
#import "FFHexagonImageSource.h"

@implementation RCTConvert (FFHexagonImage)
...
+ (FFHexagonImageSource *)FFHexagonImageSource:(id)json {
    ...
    FFHexagonImageSource *imageSource = [[FFHexagonImageSource alloc] initWithURL:uri priority:priority headers:headers cacheControl:cacheControl];

    return imageSource;
}

RCT_ARRAY_CONVERTER(FFHexagonImageSource);
